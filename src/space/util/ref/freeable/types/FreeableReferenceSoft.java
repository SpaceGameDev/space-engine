...
public abstract class FreeableReferenceSoft<T> extends SoftReference<T> implements IFreeableReference {
	...
	public FreeableReferenceSoft(T referent, IFreeableReference getSubList) {
